"""
Django settings for supplytime_47250 project.
...
ROOT_URLCONF = 'supplytime_47250.urls'
...
WSGI_APPLICATION = 'supplytime_47250.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "supplytime_47250 API",
    "DESCRIPTION": "API documentation for supplytime_47250 App",
    "VERSION": "v1",
}
